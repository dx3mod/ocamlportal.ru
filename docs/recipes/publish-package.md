...
Помимо всего прочего настоятельно рекомендуем самостоятельно [ознакомиться с правилами
и условиями публикации вашего пакета в репозитории OPAM](https://github.com/ocaml/opam-repository/blob/master/CONTRIBUTING.md), [политиками](https://github.com/ocaml/opam-repository/blob/master/governance/policies/README.md), в особенности с [политикой архивации](https://github.com/ocaml/opam-repository/blob/master/governance/policies/archiving.md)!.

> [!NOTE] Читайте также
> 
> - [Ведение пакета в OPAM репозитории](./package-maintenance.md)
